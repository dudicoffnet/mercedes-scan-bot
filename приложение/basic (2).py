...
CHANNEL_ID = -1002076509155  # Канал "Диагностика мерседес" — сюда падают все заявки
MASTER_USERNAME = "u_468345698"  # Кнопка "Связаться в Telegram" ведёт на этот @username
CHANNEL_OPEN_URL = "https://t.me/+3kyBWqh-b1lkZDEy"  # Кнопка "Открыть канал"
...
BANNER_URL = os.getenv("BANNER_URL")          # если нет file_id, можно указать прямую ссылку на картинку
...
async def booking_phone(m: Message, state: FSMContext):
    ...
    try:
        ...
        # Мягко подсказать, если бот не админ канала
